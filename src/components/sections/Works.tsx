...
import { FaBrain, FaGlobe, FaHtml5 } from "react-icons/fa";
    ...
    <section id="work" className="pb-12 sm:pb-16 lg:py-24">
      <div className="container mx-auto px-4 sm:px-6 md:px-8 [container-type:inline-size]">
        ...
        <div className="space-y-12 sm:space-y-16 md:space-y-20">
          <WorkCard
            title="01 | Smart Platform for Business Opportunity Detection"
            image="/image1.avif"
          ...
          />
          <WorkCard
            title="02 | Building SEO-Optimized Travel Platforms"
            image="/image2.avif"
          ...
          <WorkCard
            title="03 | Frontend Teaching & Interactive Coding Programs"
            image="/zharfa-site-preview.jpg"
            icon={<GiTeacher />}
            heading="Teaching & Curriculum Design"
          ...
          />
          <WorkCard
            title="04 | Teaching Web Development"
            image="/zharfa-site-preview.jpg"
            icon={<GiTeacher />}
          ...
          />
          <WorkCard
            title="05 | Creating Interfaces for Healthcare Management Systems"
            image="/almas-cover.jpg"
            icon={<FaHtml5 />}
            heading="Junior Frontend Developer - Research Internship - Final Project"
          ...
          This role helped strengthen my foundation in frontend performance and layout best practices for real-world apps. Also I designed and implemented the frontend for an academic IHMS dashboard as part of my thesis. During my bachelor's program
